function save_stl(N,E, disp, avg_beam, directory)
...
STLstuct.vertices = Nx;
STLstuct.faces = Fx;
filename = fullfile(directory, sprintf('struct_%i_%i.stl', round(disp), round(avg_beam)));
stlwrite(filename,STLstuct);
